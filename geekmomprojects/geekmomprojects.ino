...
//  Use the following global variables and access functions to calibrate the acceleration sensor
float base_x_accel;
float base_y_accel;
float base_z_accel;
float base_x_gyro;
...
void loop() {
  ...
  float accel_x = accel_t_gyro.value.x_accel+2050;
  float accel_y = accel_t_gyro.value.y_accel-3350;
  float accel_z = accel_t_gyro.value.z_accel-4550;
